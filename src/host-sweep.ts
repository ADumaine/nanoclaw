...
import { openInboundDb, openOutboundDb, inboundDbPath, heartbeatPath, sessionDir } from './session-manager.js';
...
/**
 * Reap sessions that have been idle longer than SESSION_TTL_MS.
 * Kills any still-running container, deletes the session row, and removes
 * the session directory from disk.
 */
